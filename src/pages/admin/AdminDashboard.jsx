        ...
        <div>
            ...
            <Link to="/" className="absolute top-5 left-5">
                <button
                    ...
                    className="home-button absolute top-5 left-5 bg-pink-500 text-white rounded-full w-12 h-12 flex items-center justify-center hover:bg-pink-600 focus:outline-none"
                >
                    <svg
                        ...
                        <path
                            ...
                            d="M3 12l9-9 9 9M4 10v10a2 2 0 002 2h3a2 2 0 002-2v-4a2 2 0 012 0v4a2 2 0 002 2h3a2 2 0 002-2V10"
                        />
                    </svg>
                </button>
            </Link>
            ...
            <div className="px-5">
                ...
                <div>
                    <Tabs>
                        ...
                        <TabPanel>
                            <OrderDetail orders={getAllOrder} />
                        </TabPanel>
